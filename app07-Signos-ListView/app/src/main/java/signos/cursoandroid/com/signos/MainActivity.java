...
public class MainActivity extends Activity {
    ...
    private String[] signos = {
            "Aries", "Touro", "Gemeos", "Cancer", "Leão", "Virgem",
            "Libra", "Escorpião", "Sagitario", "Capricornio", "Aquario", "Peixes"
    };

    private String[] perfis = {
            "Coxinha", "Arroz com feijão", "Pizza",
            "Lazanha", "Macarronada", "Salada de frutas",
            "Chocolates", "Salgadinhos", "Churrasco",
            "Pierogui", "Sushi", "Bolinhos"
    };
